...
public class MainActivity extends AppCompatActivity implements GetDataContract.View, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPresenter.getDataFromURL(getApplicationContext(), url);
